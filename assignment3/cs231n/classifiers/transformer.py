...
class CaptioningTransformer(nn.Module):
    ...
    def forward(self, features, captions):
        ...
        ############################################################################
        # I finished it with the help of github, I still don't understand it.
        ...
        tgt_mask = torch.ones(T, T, device=caption_embeddings.device, dtype = caption_embeddings.dtype)
        tgt_mask = torch.tril(tgt_mask)
        features = self.transformer(tgt=caption_embeddings, memory=proj, tgt_mask=tgt_mask)
        # decode = self.transformer(captions, features)
